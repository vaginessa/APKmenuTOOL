...
if __name__ == "__main__":
    ...
    operate = {'1':'func1', '2':'func2', '3':'func3', '4':'func4', '5':'func5'}

    def func1(filepath, toolspath):
        #自定义函数体
        result = {'result':u'请到"安装目录/tools/python/CustomPlug3.py"中的func1函数中添加自定义功能!'}
        return result

    def func2(filepath, toolspath):
        result = {'result':u'请到"安装目录/tools/python/CustomPlug3.py"中的func2函数中添加自定义功能!'}
        return result

    def func3(filepath, toolspath):
        result = {'result':u'请到"安装目录/tools/python/CustomPlug3.py"中的func3函数中添加自定义功能!'}
        return result

    def func4(filepath, toolspath):
        result = {'result':u'请到"安装目录/tools/python/CustomPlug3.py"中的func4函数中添加自定义功能!'}
        return result

    def func5(filepath, toolspath):
        result = {'result':u'请到"安装目录/tools/python/CustomPlug3.py"中的func5函数中添加自定义功能!'}
        return result
        ...
        try:
            ...
            if function and function != '':
                ...
                if ret and type(ret) == dict:
                    if 'result' in ret.keys() and ret['result'] != '':
                        result = ret['result']
                    else:
            ...
            result = u"自定义插件" + str(index) + u"处理异常，原因：" + str(e)
