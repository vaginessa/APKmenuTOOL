                    ...
                    if str(resFileName).startswith('res/', 0) and str(resFileName).endswith('/' + filename):
                        ...
                        try:
                            ...
                            with open(filepath,'rb') as pngfile:
                                ...
                                typee = dstfilePath[length-4:length]
                                dstfilePath = dstfilePath[0:length-4] +'_'+ str(size)+typee
...
def main():
     zipmgr.unzip_allIocn_to_dir(r'D:\\Android\\android1\\app-2.apk',r'res/mipmap-hdpi-v4/ic_launcher.png',r'D:\\Android\\android1')
